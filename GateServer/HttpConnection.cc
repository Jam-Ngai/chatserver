...
void HttpConnection::Start() {
  ...
  http::async_read(
      socket_, buffer_, request_, [=](beast::error_code ec, std::size_t) {
        try {
          if (ec) {
            std::cout << "Http read error is  " << ec.message() << std::endl;
            return;
          }
          self->HandleRequest();
          self->CheckDeadline();
...
void HttpConnection::WriteResponse() {
  ...
  http::async_write(socket_, response_, [=](beast::error_code ec, std::size_t) {
